...
Помимо практического освоения технологий, проект нацелен на практику работы в команде с git (Что очень пригодилось в реальной работе) и фиксаций изменений в коде
